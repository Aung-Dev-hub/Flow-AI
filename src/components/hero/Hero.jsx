          ...
          <div className="bg-linear-to-br from-gray-900/20 to-gray-800/20 backdrop-blur-sm rounded-lg overflow-hidden h-70 sm:w-87.5 lg:h-112.5 border border-white/5">
            ...
            <div className="p-3 sm:p-4 relative h-full">
              ...
              <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                <button onClick={()=> setActiveTab("App.jsx")}
                ...
                <button onClick={()=> setActiveTab("Hero.jsx")}
              ...
              <div className="relative overflow-hidden grow">
                <SyntaxHighlighter key={activeTab}language="javascript" style={nightOwl} customStyle={{margin: 0, borderRadius: "8px", fontSize: "11px", lineHeight: "1.4", height: "100%", border: "1px solid #3c3c3c"}}>
